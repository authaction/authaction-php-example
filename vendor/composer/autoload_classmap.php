...
return array(
    'App\\JwtValidator' => $baseDir . '/src/JwtValidator.php',
    'Attribute' => $vendorDir . '/symfony/polyfill-php80/Resources/stubs/Attribute.php',
    'AuthAction\\Auth' => $vendorDir . '/authaction/authaction-php-sdk/src/Auth.php',
    'AuthAction\\AuthAction' => $vendorDir . '/authaction/authaction-php-sdk/src/AuthAction.php',
    'AuthAction\\AuthActionClient' => $vendorDir . '/authaction/authaction-php-sdk/src/AuthActionClient.php',
    'AuthAction\\AuthorizationUrlResult' => $vendorDir . '/authaction/authaction-php-sdk/src/AuthorizationUrlResult.php',
    'AuthAction\\Cookies' => $vendorDir . '/authaction/authaction-php-sdk/src/Cookies.php',
    'AuthAction\\CurlHttpClient' => $vendorDir . '/authaction/authaction-php-sdk/src/CurlHttpClient.php',
    'AuthAction\\Exception\\AuthActionException' => $vendorDir . '/authaction/authaction-php-sdk/src/Exception/AuthActionException.php',
    'AuthAction\\Exception\\TokenExpiredException' => $vendorDir . '/authaction/authaction-php-sdk/src/Exception/TokenExpiredException.php',
    'AuthAction\\Exception\\TokenInvalidException' => $vendorDir . '/authaction/authaction-php-sdk/src/Exception/TokenInvalidException.php',
    'AuthAction\\HttpClientInterface' => $vendorDir . '/authaction/authaction-php-sdk/src/HttpClientInterface.php',
    'AuthAction\\JwtVerifier' => $vendorDir . '/authaction/authaction-php-sdk/src/JwtVerifier.php',
    'AuthAction\\Middleware\\LaravelMiddleware' => $vendorDir . '/authaction/authaction-php-sdk/src/Middleware/LaravelMiddleware.php',
    'AuthAction\\Middleware\\PsrMiddleware' => $vendorDir . '/authaction/authaction-php-sdk/src/Middleware/PsrMiddleware.php',
    'AuthAction\\Pkce' => $vendorDir . '/authaction/authaction-php-sdk/src/Pkce.php',
    'AuthAction\\Session' => $vendorDir . '/authaction/authaction-php-sdk/src/Session.php',
