...
class ComposerStaticInit92e3d7249f6868593eee07573acaa793
{
    ...
    public static $prefixDirsPsr4 = array (
        ...
        'AuthAction\\' =>
        array (
            0 => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src',
        ),
        'App\\' =>
        array (
            0 => __DIR__ . '/../..' . '/src',
    ...
    public static $classMap = array (
        'App\\JwtValidator' => __DIR__ . '/../..' . '/src/JwtValidator.php',
        'Attribute' => __DIR__ . '/..' . '/symfony/polyfill-php80/Resources/stubs/Attribute.php',
        'AuthAction\\Auth' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Auth.php',
        'AuthAction\\AuthAction' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/AuthAction.php',
        'AuthAction\\AuthActionClient' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/AuthActionClient.php',
        'AuthAction\\AuthorizationUrlResult' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/AuthorizationUrlResult.php',
        'AuthAction\\Cookies' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Cookies.php',
        'AuthAction\\CurlHttpClient' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/CurlHttpClient.php',
        'AuthAction\\Exception\\AuthActionException' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Exception/AuthActionException.php',
        'AuthAction\\Exception\\TokenExpiredException' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Exception/TokenExpiredException.php',
        'AuthAction\\Exception\\TokenInvalidException' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Exception/TokenInvalidException.php',
        'AuthAction\\HttpClientInterface' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/HttpClientInterface.php',
        'AuthAction\\JwtVerifier' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/JwtVerifier.php',
        'AuthAction\\Middleware\\LaravelMiddleware' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Middleware/LaravelMiddleware.php',
        'AuthAction\\Middleware\\PsrMiddleware' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Middleware/PsrMiddleware.php',
        'AuthAction\\Pkce' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Pkce.php',
        'AuthAction\\Session' => __DIR__ . '/..' . '/authaction/authaction-php-sdk/src/Session.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit92e3d7249f6868593eee07573acaa793::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit92e3d7249f6868593eee07573acaa793::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit92e3d7249f6868593eee07573acaa793::$classMap;
